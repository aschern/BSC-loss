...
class STSDataReaderBinary:
    ...
    def __init__(self, dataset_folder, s1_col_idx=0, s2_col_idx=1, score_col_idx=2, delimiter="\t",
                 quoting=csv.QUOTE_NONE, normalize_scores=True, min_score=0, max_score=5, thr=0.5):
...
class STSBenchmarkDataReaderBinary(STSDataReaderBinary):
    """
